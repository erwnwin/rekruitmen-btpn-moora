                            ...
                            <tbody>
                                <?php foreach ($alternatif as $alt) : ?>
                                    <tr>
                                        ...
                                        <?php foreach ($kriteria as $val) :  ?>
                                            <td>
                                                <?php $data_perhitungan_nilai = $this->m_public->get_niai_setiap_alternatif($alt->id_akun_calon_pegawai, $val->id_kriteria);
            ...
            <div class="modal-content">
                ...
                <div class="modal-body table-responsive">
                    <div class="card-body">
                        ...
                        <textarea name="pesan" cols="5" rows="3" class="form-control" readonly>Anda dinyatakan LOLOS pada Posisi Public Relationship dalam Seleksi Penerimaaan Calon Pegawai Bank BTPN KC Makassar. Terima kasih atas partisipasi saudara/i</textarea>
