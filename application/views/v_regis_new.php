                    ...
                    <div class="col-12 col-md-10 d-none d-xl-block">
                        <nav class="site-navigation position-relative text-right" role="navigation">
                            ...
                            <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                                ...
                                <li><a href="<?= base_url('auth/register') ?>" class="nav-link btn-warning text-white">Registrasi</a></li>
                                <li><a href="<?= base_url('auth/login') ?>" class="nav-link ">Masuk</a></li>
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?= base_url('auth/register_aksi') ?>" method="POST">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Nama Lengkap Anda" name="nama_lengkap_pengguna" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" class="form-control" value="Calon Pegawai" name="hak_akses" required>
                                    </div>

                                    <div class="form-group">
                                        <input type="password" class="form-control" placeholder="Password Anda" name="password" required>
                                    </div>
                                    <button type="submit" id="button" class="btn btn-warning deep-purple btn-block ">Registrasi</button>
                                    <br>
