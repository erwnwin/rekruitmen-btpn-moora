...
<body id="gradient4">
                        ...
                        <div class="info">
                            ...
                            <form action="<?= base_url('register/registration') ?>" method="post">
                                ...
                                <div class="from-group text-center">
                                    <input type="checkbox" name="agree" value="Agree" required> Saya menyetujui <a type="button" class="text-warning" data-toggle="modal" data-target="#modal-lg">ketentuan dan persyaratan yang berlaku</a>
                                </div>
    ...
    <!-- Sweetalert -->
    <script src="<?= base_url() ?>assets/depan/js/sweetalert2.min.js"></script>
    <script src="<?= base_url() ?>assets/depan/js/sweetalert2.all.min.js"></script>
    <script src="<?= base_url() ?>assets/depan/js/myscript.js"></script>
