<?php
$this->load->view('template_ujian/head');
?>
...
<?php
$this->load->view('template_ujian/topbar');
?>
        ...
        <div class="col-md-9">
            <div class="box box-success box-solid">
                ...
                <div class="box-body" style="overflow-y: scroll;height: 525px;">
                    <form id="formSoal" role="form" action="<?php echo base_url(); ?>ujian/jawab_aksi" method="post" onsubmit="return confirm('Anda Yakin ?')">
...
<?php
$this->load->view('template_ujian/js');
?>
...
<?php
$this->load->view('template_ujian/foot');
?>