                    ...
                    <div class="card-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="soal" id="summernote1" name="soal" required></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Jawaban A</label>
                                <div class="col-sm-10">
                                    <textarea rows="2" class="form-control" style="width: 100%" name="a" required></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Jawaban B</label>
                                <div class="col-sm-10">
                                    <textarea rows="2" class="form-control" style="width: 100%" name="b" required></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Jawaban C</label>
                                <div class="col-sm-10">
                                    <textarea rows="2" class="form-control" style="width: 100%" name="c" required></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Jawaban D</label>
                                <div class="col-sm-10">
                                    <textarea rows="2" class="form-control" style="width: 100%" name="d" required></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Jawaban E</label>
                                <div class="col-sm-10">
                                    <textarea rows="2" class="form-control" style="width: 100%" name="e" required></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <a href="<?= base_url('bank_soal') ?>" class="btn btn-default btn-flat"><span class="fa fa-arrow-left"></span> Kembali</a>
